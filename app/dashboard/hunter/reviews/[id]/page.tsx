      ...
      {feedback ? (
        <div className="feedback-grid">
          ...
          <aside className="panel">
            ...
            {rating ? <div className="existing-rating"><strong>{rating.stars}/10</strong><p>{rating.comment}</p><small>{rating.stars > 7 ? "Reviewer earning released." : "Reviewer earning was not released because the score was not above 7/10."}</small></div> : <RatingForm requestId={request.id} />}
          </aside>
        </div>
      ) : (
